    ...
    int       nCmdShow)
{
    ...
    return StdqcgamePlayer::createAndRun();
}

int StdqcgamePlayer::createAndRun(void)
{
    StdqcgamePlayer *host = StdqcgamePlayer::sharedInstance();
    int ret = host->run();
    StdqcgamePlayer::purgeSharedInstance();
    return ret;
}

StdqcgamePlayer *StdqcgamePlayer::s_sharedInstance = NULL;

StdqcgamePlayer *StdqcgamePlayer::sharedInstance(void)
{
    if (!s_sharedInstance)
    {
        s_sharedInstance = new StdqcgamePlayer();
    }
    return s_sharedInstance;
}

void StdqcgamePlayer::purgeSharedInstance(void)
{
    if (s_sharedInstance)
    {
...
StdqcgamePlayer::StdqcgamePlayer(void)
: m_app(NULL)
, m_hwnd(NULL)
, m_exit(TRUE)
...
int StdqcgamePlayer::run(void)
{
    ...
    do
    {
        ...
        SetWindowTextA(m_hwnd, "stdqcgame-player");
...
void StdqcgamePlayer::loadProjectConfig(void)
{
    vector<string> args;
...
void StdqcgamePlayer::createViewMenu(void)
{
...
void StdqcgamePlayer::updateMenu(void)
{
    HMENU menu = GetMenu(m_hwnd);
    HMENU viewMenu = GetSubMenu(menu, 1);
...
void StdqcgamePlayer::updateWindowTitle(void)
{
}

void StdqcgamePlayer::relaunch(void)
{
...
void StdqcgamePlayer::writeDebugLog(const char *log)
{
...
// menu callback
void StdqcgamePlayer::onFileOpenProject(void)
{
...
void StdqcgamePlayer::onFileCreateProjectShortcut(void)
{
    ...
    if (SUCCEEDED(hres))
    {
        ...
        psl->SetDescription(L"StdqcgamePlayer");
...
void StdqcgamePlayer::onFileProjectConfig(void)
{
...
void StdqcgamePlayer::onFileRelaunch(void)
{
    relaunch();
}

void StdqcgamePlayer::onFileExit(void)
{
    DestroyWindow(m_hwnd);
}

void StdqcgamePlayer::onViewChangeFrameSize(int viewMenuID)
{
...
void StdqcgamePlayer::onViewChangeOrientation(int viewMenuID)
{
    bool isLandscape = m_project.isLandscapeFrame();
...
void StdqcgamePlayer::onViewChangeZoom(int scaleMode)
{
    float scale = 1.0f;
...
void StdqcgamePlayer::onHelpAbout(void)
{
    DialogBox(GetModuleHandle(NULL), MAKEINTRESOURCE(IDD_ABOUTBOX), m_hwnd, AboutDialogCallback);
}

// windows callback
LRESULT StdqcgamePlayer::WindowProc(UINT message, WPARAM wParam, LPARAM lParam, BOOL* pProcessed)
{
    int wmId, wmEvent;
    StdqcgamePlayer *host = StdqcgamePlayer::sharedInstance();
...
INT_PTR CALLBACK StdqcgamePlayer::AboutDialogCallback(HWND hDlg, UINT message, WPARAM wParam, LPARAM lParam)
{
